  ...
  <div class="rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
    <div class="flex justify-between items-center border-b border-gray-100 dark:border-gray-800 p-4">
      <div class="flex">
        ...
        <div class="overflow-hidden ms-3">
          <a href="#" class="block font-semibold text-truncate">{{  }} {{  }}</a>
    ...
    <div class="p-2 border-t border-gray-100 dark:border-gray-800">
      <form action="{{ }}" method="POST" class="flex">
        <input type="text" name="message" class="form-input w-full py-2 px-3 h-9 mx-2 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 dark:border-gray-800 focus:ring-0" placeholder="Enter Message..." required>
        <input type="hidden" name="sender_id" value="{{}}">
        <input type="hidden" name="receiver_id" value="{{}}">

        <div class="min-w-[125px] text-end mr-1">
          <button type="submit" class="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-[16px] text-center bg-green-600 hover:bg-green-700 border-green-600 hover:border-green-700 text-white rounded-md mr-1"><i class="mdi mdi-send"></i></button>
