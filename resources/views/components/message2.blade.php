    ...
    <div class="rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
                ...
                <div class="inline-block">
                    <div class="flex mb-3">
                        ...
                        <div class="ms-2 max-w-lg">
                            <p class="bg-white dark:bg-slate-900 text-gray-700 text-[16px] shadow dark:shadow-gray-700 dark:text-gray-200 px-3 py-2 rounded mb-1">Hey Calvin</p>
        ...
        <div class="p-2 border-t border-gray-100 dark:border-gray-800">
                ...
                <form action="{{ route('user', $user->id) }}" method="POST" class="flex">
                    <input type="text" class="form-input w-full py-2 px-3 h-9 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 dark:border-gray-800 focus:ring-0" placeholder="Enter Message..." required>
